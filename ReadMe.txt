========================================================================
    KONSOLENANWENDUNG: S5Sudoku-Projektübersicht
========================================================================

Diese S5Sudoku-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre S5Sudoku-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "S5Sudoku.pch und eine 
